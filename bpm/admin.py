...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('process', 'assigned_to','status','is_complete','element', 'deadline','return_reason', 'created_at','completed_at','bpmn_task_id','id')
    list_filter = ('process', 'assigned_to','status', 'deadline','return_reason', 'created_at', 'updated_at','completed_at','id')
